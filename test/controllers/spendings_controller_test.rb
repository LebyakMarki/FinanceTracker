...
class SpendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spending" do
    assert_difference('Spending.count') do
      post spendings_url, params: { spending: { amount: @spending.amount, category: @spending.category, description: @spending.description } }
    end
  ...
  test "should update spending" do
    patch spending_url(@spending), params: { spending: { amount: @spending.amount, category: @spending.category, description: @spending.description } }
